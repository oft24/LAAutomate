...
@registrar(nombre='ingresointento5', disparador="manual", categoria="grabada")
class Ingresointento5(BaseAutomation):
    def ejecutar(self) -> AutomationResult:
        ...
        self.escritorio.click_en(317, 98)  # Edit, sin texto identificable
        ...
        self.escritorio.click_en(349, 24)  # Edit, sin texto identificable
        self.escritorio.escribir(USUARIO)
        self.escritorio.click_en(340, 70)  # campo de Edit -- su valor no se grabó por seguridad

...
_CATEGORIAS = [
    {
        ...
        "metodos": [
            ...
            ("seleccionar(selector, valor=None, texto=None, by=...)", "Elige una opción de un <select>. Un desplegable no se automatiza escribiendo dentro: hay que usar esto o el formulario se envía vacío."),
            ("descargar_en(carpeta)", "Manda las descargas del navegador a esa carpeta. Llámalo ANTES del primer ir_a()."),
            ("esperar_descarga(carpeta, extension=\".pdf\", timeout=30)", "Espera a que el archivo termine de bajar (Chrome escribe primero un .crdownload) y devuelve su ruta, o None."),
